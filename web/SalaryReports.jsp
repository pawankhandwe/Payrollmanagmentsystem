<%-- 
    Document   : SalaryReports
    Created on : 15 Oct, 2022, 12:27:49 AM
    Author     : HP
--%>

<%@page import="salary.salarydao"%>
<%@page import="salary.salarypojo"%>
...
<div class="table-wrapper">
  ...
  <tr>
    ...
    <th>SALARY_NOTES</th>
     ...
     <tbody>
          <%
    List<salarypojo>list=salarydao.getallsalarydetail();
    for(salarypojo obj:list)
    {
      out.println("<tr>");
        out.println("<td>"+obj.getName()+"</td>");
        out.println("<td>"+obj.getSalarymonth()+"</td>");
        out.println("<td>"+obj.getWorkingdays()+"</td>");
         out.println("<td>"+obj.getBasic_pay()+"</td>");
        out.println("<td>"+obj.getHra()+"</td>");
         out.println("<td>"+obj.getTax_for_month()+"</td>");
          out.println("<td>"+obj.getSalary_note()+"</td>");
         out.println("</tr>");
