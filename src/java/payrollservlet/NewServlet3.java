...
public class NewServlet3 extends HttpServlet {
    ...
    con=DriverManager.getConnection("jdbc:oracle:thin:@//localhost:1521/xe","payrollsystem","java");
       ...
       if(result==1)
       {
           response.setStatus(1,"new employee added");
           out.print("new employee added sucessfully");
       ...
       JOptionPane.showMessageDialog(null,"new employee added","sucess!",JOptionPane.INFORMATION_MESSAGE);
           }
